...
def _resolves(claim: str) -> bool:
    ...
    `quietz/thing.py` because that is the import path a reader types, and the file is at
    `src/quietz/thing.py`. Both are correct and a check that refused the first would be wrong.
    """
