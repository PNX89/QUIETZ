...
```bash
git clone https://github.com/PNX89/QUIETZ.git && cd QUIETZ
uv sync --dev
...
- the alert rules, unit tested in both directions
...
https://pnx89.github.io/QUIETZ, come from a real run whose output is committed under
